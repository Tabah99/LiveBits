                    ...
                    <div class="content">
                        <div class="module message">
                            <div class="module-head">
                                <h2 style="    display: contents;">Rent Details</h2>
                                <a href="#" class="btn btn-primary pull-right" id="myBtn" data-toggle="modal" data-target="#myModal">Create Entity
                                    </a>
                                    <hr>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <?php
                                                echo form_open('rent_cont/insertData');
                                                ?>
                                                <h2>Rental Sheet</h2>
                                                ...
                                                <p>
                                                    ...
                                                    <br>
                                                    <label>Rent</label>
                                                    <input type="text" name="rent" required=""><br><br>
                                                    <label>
                                                        Electricity
                                                    </label>
                        ...
                        <table class="table table-hover no-more-tables">
                            <tbody>
                                <tr class="heading">
                                    ...
                                    <td class="cell-status hidden-phone hidden-tablet">Electricity Bill</td>
                                    <td class="cell-status">Rent</td>
                                    <td class="cell-status">Total</td>
                                    <td class="cell-time align-center">Actions</td>
                                </tr>
                                ...
                                ?>  
                                        <tr class="task">
                                            ...
                                            <td class="cell-status hidden-phone hidden-tablet">
                                                <div><?php echo $rows->elec; ?></div>
                                            </td>
                                            <td class="cell-status">
                                                <div><?php echo $rows->rent; ?></div>
                                            </td>
                                            <?php $rent = $rows->rent;
                                            $elec = $rows->elec;
                                            $sum = $rent + $elec;
                                            ...
                                            <td class="cell-status"><?php echo $sum ?></td>
                                            <td class="cell-time align-right"><a href="<?= site_url('rent_cont/updatePage/'.$abc)?>" class="btn btn-info">Edit</a>&nbsp;
                                                <a href="<?= site_url('rent_cont/delete_c/' . $abc) ?>" class="btn btn-danger">Delete</a>
                                        </tr>
                                <?php
