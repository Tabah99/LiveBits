            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="#">LiveBits ErP </a>
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            ...
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="task.html"><i class="menu-icon icon-bullhorn"></i>Employee Table </a>
                                </li>
                                <li><a href="<?=site_url('rent_cont') ?>"><i class="menu-icon icon-inbox"></i>Rental Sheet  </a></li>
                                <li><a href="task.html"><i class="menu-icon icon-tasks"></i>Miscellaneous  </a></li>
                                <li><a href="task.html"><i class="menu-icon icon-tasks"></i>Projects  </a></li>
                                <li><a href="task.html"><i class="menu-icon icon-tasks"></i>Balance Sheet  </a></li>
                            </ul>
                            <!--/.widget-nav-->
