      ...
      <div class="page-content">
                                ...
                                <table class="table table-message">
                                    <tbody>
                                        <tr class="heading">
                                            ...
                                            <td class="cell-title">Serial No</td>
                                            <td class="cell-status hidden-phone hidden-tablet">Employee Name</td>
                                            <td class="cell-status">Salary</td>
                                            <td class="cell-status">Salary Type</td>
                                            <td class="cell-status">Salary Month</td>
                                            <td class="cell-status">Delete Record</td>
                                            <td class="cell-time align-right">Update Record</td>
                                        </tr>
		...
		if(!empty($salary)){
			foreach ($salary as $key => $value) {?>
				<tr>
					<td class="cell-title"><?=$key+1 ?></td>
					<td class="cell-status hidden-phone hidden-tablet"><?=$value->name ?></td>
					<td class="cell-status"><?=$value->price ?></td>
					<td class="cell-status"><?=$value->salary_type ?></td>
					<td class="cell-status"><?=$value->salary_month ?></td>
...
?>
  <h6>
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?=site_url('site/delete/'.$abc."/".$value->employ_Id) ?>" class="btn btn-danger"> Delete </a></h6>
</td>
<td class="cell-time align-right">
   <h6>
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo anchor("site/update/$abc",'Update',['class'=>'btn btn-info']); ?></h6></td>
<br>
<?php
}
else{
