        ...
        <div class="container">
                ...
                <!--/.span3-->
                    <div class="content">
                                                ...
                                                echo form_open('rent_cont/updatedata');
                                                
                                                ?>
                                                <h2>Rental Sheet</h2>
                                                <input type="hidden" name="id" value="<?= $value->id_rent ?>">
                                                <p>


                                                    <label>Select Date </label>
                                                    <input type="date" value="<?= $value->Month ?>" name="Month">

                                                    <br>
                                                    <br>
                                                    <label>Rent</label>
                                                    <input type="text" name="rent" value="<?= $value->rent ?>" required=""><br><br>
                                                    <label>
                                                        Electricity
                                                    </label>
                                                    <input type="text" name="elec" value="<?= $value->elec ?> " required>
                                                </p>
